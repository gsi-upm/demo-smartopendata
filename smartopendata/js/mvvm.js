...
function InitViewModel() {
	...
	var temporal = fuseki_endpoint + encodeURIComponent(polygonsfeuro_query); 
        var req = new XMLHttpRequest();
        req.open("GET", temporal, true);
	...
	self.routes = function () {
		...
		if (self.serverURL() == "") {
			...
			sammyPlugin = $.sammy(function () {
                ...
                this.get('#/sparql/slovakiaPolygonsDemo', function () {
                    ...
                    templateWidgetsLeft.push({
                        ...
                        layout: 'horizontal',
                        showWidgetConfiguration: false,
                        help: 'This option enable users to select areas according to nature and landscape protection features'
                    });
                    ...
                    templateWidgetsLeft.push({
                        ...
                        layout: 'horizontal',
                        showWidgetConfiguration: false,
                        help: 'This option enable users to choose large scale protected areas'
                    });
                    ...
                    templateWidgetsLeft.push({
                        ...
                        layout: 'horizontal',
                        showWidgetConfiguration: false,
                        help: 'This option enable users to choose areas according to areasLocal ID values'
                    });
                    ...
                    templateWidgetsLeft.push({
                        ...
                        layout: 'horizontal',
                        showWidgetConfiguration: false,
                        help: 'This option enable users to choose areas according to Protection classification values'
                    });
                    ...
                    templateWidgetsLeft.push({
                        ...
                        layout: 'horizontal',
                        showWidgetConfiguration: false,
                        help: 'This option enable users to choose areas according to namespace values'
                    });
			...
			_editorEndpoint = fuseki_endpoint;
