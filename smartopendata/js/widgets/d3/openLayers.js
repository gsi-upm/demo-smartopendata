...
var openLayers = {
    ...
    help: 'This widget enables users to explorer different kind of protected areas in Slovakia. By using a map clustering feature user can zoom the widget for getting the name and area attributes',
