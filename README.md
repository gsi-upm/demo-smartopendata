...
##Getting Started 
If you want to easy try Sefarad, just download this repository (cloning it to your computer or downloading it as a .zip in [here](https://lab.gsi.dit.upm.es/SmartOpenDataDemoBundle/demo-smartopendata-bundled-package.zip)) and open in your web browser the file `demo.html` located in the `build /` folder. 
